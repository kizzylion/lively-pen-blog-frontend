          ...
          <CardContent className="space-y-4 text-left px-0">
            <div className="space-y-3 ">
              ...
              <div className="relative">
                <User className="absolute left-3 top-3 size-4 text-tertiary" />
                <Input
                  id="name"
                  type="text"
            ...
            <div className="space-y-3 ">
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-3 size-4 text-tertiary" />
                <Input
                  id="email"
                  type="email"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-3 size-4 text-tertiary" />
                <Input
                  id="password"
                ...
                <button
                  ...
                  className="absolute right-3 top-3 text-tertiary hover:text-tertiary-hover"
                >
                  {showPassword ? (
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-primary px-3 text-tertiary">
                    Or continue with
                  </span>
                </div>
              </div>
